...
void RoverAckermannStatus_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) px4_msgs::msg::RoverAckermannStatus(_init);
}

void RoverAckermannStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::RoverAckermannStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RoverAckermannStatus_message_member_array[4] = {
  {
    ...
    offsetof(px4_msgs::msg::RoverAckermannStatus, timestamp),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoverAckermannStatus_message_members = {
  ...
  RoverAckermannStatus_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t RoverAckermannStatus_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &RoverAckermannStatus_message_members,
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::RoverAckermannStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, RoverAckermannStatus)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::RoverAckermannStatus_message_type_support_handle;
}
