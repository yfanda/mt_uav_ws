...
bool px4_msgs__msg__rover_mecanum_guidance_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._rover_mecanum_guidance_status.RoverMecanumGuidanceStatus", full_classname_dest, 70) == 0);
  }
  px4_msgs__msg__RoverMecanumGuidanceStatus * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of RoverMecanumGuidanceStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._rover_mecanum_guidance_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoverMecanumGuidanceStatus");
