...
px4_msgs__msg__RoverMecanumGuidanceStatus__create()
{
  ...
  px4_msgs__msg__RoverMecanumGuidanceStatus * msg = (px4_msgs__msg__RoverMecanumGuidanceStatus *)allocator.allocate(sizeof(px4_msgs__msg__RoverMecanumGuidanceStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RoverMecanumGuidanceStatus__Sequence__init(px4_msgs__msg__RoverMecanumGuidanceStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RoverMecanumGuidanceStatus *)allocator.zero_allocate(size, sizeof(px4_msgs__msg__RoverMecanumGuidanceStatus), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs__msg__RoverMecanumGuidanceStatus__Sequence * array = (px4_msgs__msg__RoverMecanumGuidanceStatus__Sequence *)allocator.allocate(sizeof(px4_msgs__msg__RoverMecanumGuidanceStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  px4_msgs__msg__RoverMecanumGuidanceStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    px4_msgs__msg__RoverMecanumGuidanceStatus * data =
      (px4_msgs__msg__RoverMecanumGuidanceStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__RoverMecanumGuidanceStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__RoverMecanumGuidanceStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
