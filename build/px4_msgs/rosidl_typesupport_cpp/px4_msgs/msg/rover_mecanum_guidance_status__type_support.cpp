...
static const _RoverMecanumGuidanceStatus_type_support_symbol_names_t _RoverMecanumGuidanceStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, RoverMecanumGuidanceStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, RoverMecanumGuidanceStatus)),
  }
};
...
{
  return &::px4_msgs::msg::rosidl_typesupport_cpp::RoverMecanumGuidanceStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_msgs, msg, RoverMecanumGuidanceStatus)() {
  return get_message_type_support_handle<px4_msgs::msg::RoverMecanumGuidanceStatus>();
}
