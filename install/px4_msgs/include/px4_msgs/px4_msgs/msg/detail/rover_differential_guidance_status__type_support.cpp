...
{
  new (message_memory) px4_msgs::msg::RoverDifferentialGuidanceStatus(_init);
}

void RoverDifferentialGuidanceStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::RoverDifferentialGuidanceStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RoverDifferentialGuidanceStatus_message_member_array[4] = {
  {
    ...
    offsetof(px4_msgs::msg::RoverDifferentialGuidanceStatus, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::RoverDifferentialGuidanceStatus, lookahead_distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::RoverDifferentialGuidanceStatus, heading_error_deg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::RoverDifferentialGuidanceStatus, state_machine),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoverDifferentialGuidanceStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(px4_msgs::msg::RoverDifferentialGuidanceStatus),
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::RoverDifferentialGuidanceStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, RoverDifferentialGuidanceStatus)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::RoverDifferentialGuidanceStatus_message_type_support_handle;
}
