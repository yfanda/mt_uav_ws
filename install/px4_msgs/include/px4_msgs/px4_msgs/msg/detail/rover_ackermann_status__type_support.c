...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__RoverAckermannStatus__rosidl_typesupport_introspection_c__RoverAckermannStatus_message_member_array[4] = {
  {
    "timestamp",  // name
