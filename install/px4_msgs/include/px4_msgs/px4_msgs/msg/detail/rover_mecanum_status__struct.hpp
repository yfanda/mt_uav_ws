...
#ifndef PX4_MSGS__MSG__DETAIL__ROVER_MECANUM_STATUS__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ROVER_MECANUM_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__RoverMecanumStatus __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__RoverMecanumStatus __declspec(deprecated)
#endif
...
struct RoverMecanumStatus_
{
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__RoverMecanumStatus
    std::shared_ptr<px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__RoverMecanumStatus
    std::shared_ptr<px4_msgs::msg::RoverMecanumStatus_<ContainerAllocator> const>
...
using RoverMecanumStatus =
  px4_msgs::msg::RoverMecanumStatus_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ROVER_MECANUM_STATUS__STRUCT_HPP_
