...
class Metaclass_RoverMecanumSetpoint(type):
    """Metaclass of message 'RoverMecanumSetpoint'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.RoverMecanumSetpoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rover_mecanum_setpoint
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rover_mecanum_setpoint
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rover_mecanum_setpoint
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rover_mecanum_setpoint
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rover_mecanum_setpoint
...
class RoverMecanumSetpoint(metaclass=Metaclass_RoverMecanumSetpoint):
    """Message class 'RoverMecanumSetpoint'."""
    ...
    def __eq__(self, other):
        ...
        if self.forward_speed_setpoint_normalized != other.forward_speed_setpoint_normalized:
            return False
        if self.lateral_speed_setpoint != other.lateral_speed_setpoint:
            return False
        if self.lateral_speed_setpoint_normalized != other.lateral_speed_setpoint_normalized:
            return False
    ...
    @builtins.property
    def lateral_speed_setpoint(self):
        """Message field 'lateral_speed_setpoint'."""
        return self._lateral_speed_setpoint

    @lateral_speed_setpoint.setter
    def lateral_speed_setpoint(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'lateral_speed_setpoint' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'lateral_speed_setpoint' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._lateral_speed_setpoint = value

    @builtins.property
    def lateral_speed_setpoint_normalized(self):
        """Message field 'lateral_speed_setpoint_normalized'."""
        return self._lateral_speed_setpoint_normalized

    @lateral_speed_setpoint_normalized.setter
    def lateral_speed_setpoint_normalized(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'lateral_speed_setpoint_normalized' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'lateral_speed_setpoint_normalized' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._lateral_speed_setpoint_normalized = value
