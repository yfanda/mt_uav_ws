...
bool px4_msgs__msg__rover_differential_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._rover_differential_status.RoverDifferentialStatus", full_classname_dest, 63) == 0);
  }
  px4_msgs__msg__RoverDifferentialStatus * ros_message = _ros_message;
  {  // timestamp
...
PyObject * px4_msgs__msg__rover_differential_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._rover_differential_status");
